...
!  pre-defined parameters
   ...
   integer, parameter        :: FROMUSFILE=8
...
!        Empirical spectrum
      ...
      case (FROMUSFILE)
         open(unit=15, file=usp_file, status='old', action='read')
         read(15, *) 
         do i=1,nlev
           read(15, *) vstokes(i),ustokes(i),vstokes(i)
         enddo
         close(15)
      case default
   ...
   LEVEL1 'printing the values',ustokes(1),ustokes(100),vstokes(3)
...
!        Empirical spectrum
      ...
      case (FROMUSFILE)
         ! We do nothing here as ustokes and vstokes are already read from file
      case default
         LEVEL1 'A non-valid ustokes_method has been given ', ustokes_method
         stop 'stokes_drift()'
   end select
